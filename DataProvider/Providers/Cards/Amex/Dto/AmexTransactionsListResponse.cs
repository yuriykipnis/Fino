...
{
    public class AmexTransactionsListResponse
    {
    ...
    public class CardTransactionsResponse
    {
        ...
        public IList<AmexCardTransaction> TxnIsrael { get; set; } = new List<AmexCardTransaction>();

        [JsonProperty(PropertyName = "txnInfo")]
        public IList<AmexCardTransaction> TxnInfo { get; set; } = new List<AmexCardTransaction>();

        [JsonProperty(PropertyName = "txnAbroad")]
        public IList<AmexCardTransaction> TxnAbroad { get; set; } = new List<AmexCardTransaction>();
    }
    
    public class AmexCardTransaction
    {
